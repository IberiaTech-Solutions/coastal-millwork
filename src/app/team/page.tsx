...
export default function TeamPage() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-16">
      <h1 className="text-3xl font-semibold text-[var(--foreground)]">Our Team</h1>

      <figure className="mt-10">
        <div className="aspect-[2/1] w-full overflow-hidden rounded-lg bg-[var(--border)]">
        ...
        {TEAM.map((person) => (
          ...
          >
            <div className="shrink-0 sm:w-48">
              <div className="aspect-[3/4] w-full max-w-[12rem] overflow-hidden rounded-lg bg-[var(--border)]">
      ...
      <section className="mt-16 border-t border-[var(--border)] pt-14">
        ...
        <figure className="mt-6">
          <div className="aspect-video w-full max-w-2xl overflow-hidden rounded-lg bg-[var(--border)]">
